...
var userSchema = new mongoose.Schema({
	...
	//массив, в котором хранятся id документов, в которых пользователь является исполнителем
	docs_ispoln: {
		type: Array,
	},
	//массив, в котором хранятся id документов, в которых пользователь является контроллирующим
	docs_kontrols: {
		type: Array,
	}
});
